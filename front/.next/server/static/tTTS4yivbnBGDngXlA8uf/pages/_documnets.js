...
module.exports = __webpack_require__("mCij");
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  ...
  render() {
    ...
    return __jsx("html", htmlAttrs, __jsx("head", null, this.props.styleTages, Object.values(helmet).map(el => el.toComponent())), __jsx("body", bodyAttrs, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Main"], null),  true && __jsx("script", {
