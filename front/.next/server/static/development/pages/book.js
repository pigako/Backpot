...
const Book = () => {
  ...
  }), __jsx(BookButtonDiv, null, (me && me.id) === (book && book.User.id) ? __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"], null, "\uAE00\uC4F0\uB7EC\uAC00\uAE30") : null, me ? me.LikingBook.find(v => v.id === (book && book.id)) ? __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"], {
    color: "pink",
