...
const UpdateBook = () => {
  ...
  const onChagneImage = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(e => {
    ...
    dispatch({
      type: _reducers_book__WEBPACK_IMPORTED_MODULE_6__["UPLOAD_IMAGE_REQUEST"],
      data: imageFormData
    });
  }, []);
  ...
  const onSubmitForm = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(e => {
    ...
    dispatch({
      type: _reducers_book__WEBPACK_IMPORTED_MODULE_6__["UPDATE_BOOK_REQUEST"],
      data: {
        id: book && book.id,
        name: bookName,
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (isUpdatedBook) {
      dispatch({
        type: _reducers_book__WEBPACK_IMPORTED_MODULE_6__["CHANGE_UPDATEDBOOK"]
      });
