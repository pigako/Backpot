...
module.exports = __webpack_require__("VAwT");
...
const UpdateBook = () => {
  ...
  const onRemoveThumbnail = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(() => {
    if (book && book.thumbnail) {
      dispatch({
        type: _reducers_book__WEBPACK_IMPORTED_MODULE_6__[/* REMOVE_THUMBNAIL */ "z"]
      });
    } else {
      dispatch({
  ...
  const onSubmitForm = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(e => {
    ...
    dispatch({
      type: _reducers_book__WEBPACK_IMPORTED_MODULE_6__[/* UPDATE_BOOK_REQUEST */ "B"],
      data: {
        id: book && book.id,
        name: bookName,
  ...
  }, [book && book.id, bookName, book && book.thumbnail, thumbnailPath, serialDay, summaryText, genreArr]);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (isUpdatedBook) {
      dispatch({
        type: _reducers_book__WEBPACK_IMPORTED_MODULE_6__[/* CHANGE_UPDATEDBOOK */ "i"]
      });
