...
const SProfileDiv = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
  displayName: "profile__SProfileDiv",
  componentId: "sc-1n71nmh-0"
})(["width:98%;margin-top:10px;"]);
const ProfileTitle = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.h1.withConfig({
...
const InfoCardWrap = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
...
const InfoCardDiv = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
  displayName: "profile__InfoCardDiv",
  componentId: "sc-1n71nmh-3"
})(["display:flex;align-items:center;margin:1rem;height:4rem;"]);
const InfoLeftDiv = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
  displayName: "profile__InfoLeftDiv",
  componentId: "sc-1n71nmh-4"
})(["flex:1;"]);
const InfoRightDiv = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
...
const CheckButton = styled_components__WEBPACK_IMPORTED_MODULE_1___default()(_components_designs_Button__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"]).withConfig({
...
const SButton = styled_components__WEBPACK_IMPORTED_MODULE_1___default()(_components_designs_Button__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"]).withConfig({
...
const Profile = ({
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(e => {
    if (isUpdated) {
      dispatch({
        type: _reducers_user__WEBPACK_IMPORTED_MODULE_6__[/* CHANGE_UPDATED */ "b"]
      });
  ...
  const onUpdateProfile = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(e => {
    ...
    dispatch({
      type: _reducers_user__WEBPACK_IMPORTED_MODULE_6__[/* UPDATE_USER_REQUEST */ "q"],
      data: {
        userId,
        newUserPassword,
        userNickname
  ...
  return __jsx(SProfileDiv, null, __jsx(ProfileTitle, null, me && me.nickname, " \uB2D8 \uD504\uB85C\uD544 \uC218\uC815"), __jsx(InfoCardWrap, null, __jsx(InfoCardDiv, null, __jsx(InfoLeftDiv, null, __jsx("label", null, "\uC544\uC774\uB514")), __jsx(InfoRightDiv, null, __jsx("input", {
    ...
    onChange: onChangeInputs
  })) : __jsx(InfoRightDiv, null, __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
    size: 'middle',
