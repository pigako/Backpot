...
/* harmony import */ var _reducers_board__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../reducers/board */ "./reducers/board.js");
...
var CommentButton = Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["default"])(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"]).withConfig({
...
var DetailBoard = function DetailBoard() {
  ...
  var onDeleteBoard = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (e) {
    dispatch({
      type: _reducers_board__WEBPACK_IMPORTED_MODULE_10__["DELETE_BOARD_REQUEST"],
      boardId: board.id
    });
  }, []);
  return __jsx(SBoard, null, __jsx(react_helmet__WEBPACK_IMPORTED_MODULE_6___default.a, null, __jsx("title", null, board && board.title), __jsx("style", {
    type: "text/css"
  }, "\n            .ck-editor__editable { height: 200px;}\n            .ck.ck-reset.ck-editor.ck-rounded-corners {margin: 1.5rem;}\n          ")), __jsx(SDetailBoardTitle, null, "\uCD94\uCC9C\uAC8C\uC2DC\uAE00"), __jsx(SBoardTop, null, __jsx(SBoardTitle, null, __jsx(SBoardTitleLabel, null, board && board.title), __jsx(SBoardWriterLabel, null, __jsx("strong", null, board && board.User.nickname), " \uB2D8"), __jsx(SBoardCreateLabel, null, moment__WEBPACK_IMPORTED_MODULE_5___default()(board && board.createdAt).format('YY.MM.DD HH시 mm분'))), myId === (board && board.User.id) ? __jsx(SBoardTitleButtonDiv, null, __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"], {
    onClick: onUpdateBoard
  }, "\uC218\uC815"), __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"], {
    color: 'pink',
    onClick: onDeleteBoard
  }, "\uC0AD\uC81C")) : null), __jsx(SBoardContent, null, __jsx("div", {
...
DetailBoard.getInitialProps = function (context) {
  ...
  context.store.dispatch({
    type: _reducers_board__WEBPACK_IMPORTED_MODULE_10__["LOAD_BOARD_REQUEST"],
    boardId: id
  });
};
...
//# sourceMappingURL=detailboard.js.7d8f4e4782b5130b3aae.hot-update.js.map