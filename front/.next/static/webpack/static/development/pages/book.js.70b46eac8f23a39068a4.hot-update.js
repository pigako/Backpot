...
var BookTable = function BookTable(_ref) {
  var episode = _ref.episode,
      _ref$isASC = _ref.isASC,
      isASC = _ref$isASC === void 0 ? true : _ref$isASC;
  ...
  var reverseEpisode = episode.slice().reverse(); // 번호 제목 날짜 조회 추천

  return __jsx(Table, null, __jsx("thead", null, __jsx("tr", null, __jsx("th", null, "\uBC88\uD638"), __jsx("th", null, "\uC81C\uBAA9"), __jsx("th", null, "\uB0A0\uC9DC"), __jsx("th", null, "\uC870\uD68C"), __jsx("th", null, "\uCD94\uCC9C"))), __jsx("tbody", null, episode.length ? isASC ? episode.map(function (v, index) {
    return __jsx("tr", {
      key: +v.id,
      onClick: goEpisode(+v.id)
    }, __jsx("td", null, index), __jsx("td", null, v.title), __jsx("td", null, moment__WEBPACK_IMPORTED_MODULE_4___default()(v.createdAt).format('YYYY.MM.DD')), __jsx("td", null, v.views), __jsx("td", null, v.recommends));
  }) : reverseEpisode.map(function (v, index) {
    return __jsx("tr", {
      key: +v.id,
      onClick: goEpisode(+v.id)
...
//# sourceMappingURL=book.js.70b46eac8f23a39068a4.hot-update.js.map