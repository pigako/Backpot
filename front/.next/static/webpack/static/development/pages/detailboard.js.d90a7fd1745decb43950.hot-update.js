...
/* harmony import */ var _components_CommentCard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/CommentCard */ "./components/CommentCard.js");
...
var DetailBoard = function DetailBoard() {
  var _useSelector = Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["useSelector"])(function (state) {
    return state.board;
      ...
      isUpdatingBoard = _useSelector.isUpdatingBoard,
  ...
  var onUpdateBoard = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (e) {
    if (isUpdating) {
      dispatch({
        type: _reducers_board__WEBPACK_IMPORTED_MODULE_8__["UPDATE_BOARD_REQUEST"],
        data: {
          id: board.id,
          content: updateText
        }
  ...
  var onUpdateBoardCancle = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (e) {
    setIsUpdating(false);
    setUpdateText(board && board.content);
  }, [isUpdating]);
  var onDeleteBoard = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (e) {
    dispatch({
      type: _reducers_board__WEBPACK_IMPORTED_MODULE_8__["DELETE_BOARD_REQUEST"],
      boardId: board.id
    });
  }, [board && board.id]);
  var onCreateComment = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (e) {
    ...
    dispatch({
      type: _reducers_board__WEBPACK_IMPORTED_MODULE_8__["ADD_COMMENT_REQUEST"],
      data: {
        boardId: board.id,
        content: userComment
      }
  ...
  return __jsx(SBoard, null, __jsx(react_helmet__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx("title", null, board && board.title), __jsx("style", {
    ...
    return __jsx(_components_CommentCard__WEBPACK_IMPORTED_MODULE_9__["default"], {
      key: +comment.id,
      comment: comment
    });
...
//# sourceMappingURL=detailboard.js.d90a7fd1745decb43950.hot-update.js.map