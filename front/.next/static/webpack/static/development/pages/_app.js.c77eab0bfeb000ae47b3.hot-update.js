...
})(["display:block;width:calc(50% -5px);line-height:2rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;cursor:pointer;"]);
...
var LikedBook = function LikedBook(_ref) {
  ...
  }, __jsx("a", null, __jsx(Bookname, null, moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(moment__WEBPACK_IMPORTED_MODULE_4___default()().format('YYYY-MM-DD HH:mm').diff(moment__WEBPACK_IMPORTED_MODULE_4___default()('2020-03-17T02:26:58.000Z', 'YYYY-MM-DD HH:mm'))).asHours() < 24 ? New : null, book.name))));
};
...
//# sourceMappingURL=_app.js.c77eab0bfeb000ae47b3.hot-update.js.map