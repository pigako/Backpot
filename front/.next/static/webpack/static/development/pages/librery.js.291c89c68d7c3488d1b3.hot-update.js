...
var BookCard = function BookCard(_ref) {
  ...
  return __jsx(Card, null, __jsx(Thumbnail, {
    src: book.thumbnail
  }), __jsx(CardContent, null, __jsx(Title, null, book.name), __jsx(Genre, null, book.BookGenre[0].name), __jsx(Writer, null, nickname), __jsx(CreatedDate, null, "\uB4F1\uB85D\uC77C ", moment__WEBPACK_IMPORTED_MODULE_4___default()(book.createdAt).format('YYYY.MM.Do'))));
};
...
//# sourceMappingURL=librery.js.291c89c68d7c3488d1b3.hot-update.js.map