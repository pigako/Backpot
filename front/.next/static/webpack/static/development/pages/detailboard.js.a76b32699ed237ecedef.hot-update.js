...
var DetailBoard = function DetailBoard() {
  ...
  })), __jsx(SBoardComment, null, __jsx(SBoardCommentCountDiv, null, __jsx("label", null, "\uB313\uAE00 ", board && board.Comments.length, "\uAC1C")), board && console.log(board.Comments), board && board.Comments.map(function (comment) {
    __jsx(CommentCard, {
      key: +comment.id
    }, __jsx(CommentCardTop, null, __jsx(CommentCardNickname, null, comment.User.nickname), __jsx(CommentCardCreateLabel, null, moment__WEBPACK_IMPORTED_MODULE_5___default()(comment.createdAt).format('YY.MM.DD HH시 mm분'))), __jsx(CommentCardContent, null, __jsx("p", {
      dangerouslySetInnerHTML: {
...
//# sourceMappingURL=detailboard.js.a76b32699ed237ecedef.hot-update.js.map