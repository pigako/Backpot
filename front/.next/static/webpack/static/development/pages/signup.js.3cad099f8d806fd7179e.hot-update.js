...
})(["width:100%;display:flex;align-items:center;margin-bottom:10px;& > label{flex:10;margin-bottom:0px;}& > button{}"]);
...
var SignUp = function SignUp() {
  ...
  var onSubmitForm = Object(react__WEBPACK_IMPORTED_MODULE_8__["useCallback"])(function (e) {
    e.preventDefault(); // if (!userIdCheck) {
    ...
    dispatch({
      type: _reducers_user__WEBPACK_IMPORTED_MODULE_13__["SIGN_UP_REQUEST"],
      data: {
        userId: userId,
        password: password,
        nickname: nickname
  ...
  return __jsx(SignUpDesign, null, __jsx(Subject, null, "\uD68C\uC6D0\uAC00\uC785"), __jsx(SignUpForm, {
    ...
    htmlFor: "user-id"
  }, "\uC544\uC774\uB514"), __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
  ...
  }, "\uB2C9\uB124\uC784"), __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
  ...
  })), __jsx(LoginFormButtonDiv, null, __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
    type: "submit",
    color: "pink"
...
//# sourceMappingURL=signup.js.3cad099f8d806fd7179e.hot-update.js.map