...
})(["height:2rem;background:#e7e7e7;display:flex;align-items:center;& > label{font-size:1rem;font-weight:bold;margin-left:1rem;border-bottom:solid 3px #6441a5;}"]);
...
var DetailBoard = function DetailBoard() {
  ...
  })), __jsx(SBoardComment, null, __jsx(SBoardCommentCountDiv, null, __jsx("label", null, "\uB313\uAE00 ", board && board.Comments.length, "\uAC1C"))));
};
...
//# sourceMappingURL=detailboard.js.7d08c3946cd5a487d383.hot-update.js.map