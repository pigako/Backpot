...
})(["border-collapse:separate;border-spacing:1px;background:white;border-radius:6px;overflow:hidden;margin:0 auto;width:98%;& th{padding:1rem;background:#ffed86;}& td{padding:1rem;border-bottom:1px solid #7053c4;}& th:nth-child(1){width:10%;text-align:center;}& td:nth-child(1){text-align:center;}& th:nth-child(3),th:nth-child(4){width:12%;}& td:nth-child(3),td:nth-child(4){text-align:center;}"]);
...
//# sourceMappingURL=librery.js.179aaac2727a751d0be2.hot-update.js.map