...
})(["border-collapse:separate;border-spacing:1px;background:white;border-radius:12px;overflow:hidden;margin:1rem auto;width:98%;& th{padding:1rem;background:#148cff;color:white;}& td{padding:1rem;border-bottom:1px solid #7053c4;cursor:pointer;}& tr:hover{background:#495057;color:white;}"]);
...
var BookTable = function BookTable(_ref) {
  ...
  return __jsx(Table, null, __jsx("thead", null, __jsx("tr", null, __jsx("th", null, "\uBC88\uD638"), __jsx("th", null, "\uC81C\uBAA9"), __jsx("th", null, "\uB0A0\uC9DC"), __jsx("th", null, "\uC870\uD68C"), __jsx("th", null, "\uCD94\uCC9C"))), __jsx("tbody", null, episode.map(function (v) {
    return __jsx("tr", {
      key: +v.id,
...
})(["width:80%;padding:1.5rem;float:right;border:solid 2px #495057;& > label{font-size:1rem;display:block;margin-top:1rem;& > a{cursor:pointer;}}& > div{display:flex;& > label{font-size:1rem;display:block;margin-top:1rem;}label + label{margin-left:1rem;}}"]);
...
var Book = function Book() {
  ...
  }), book && __jsx(_components_BookTable__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
//# sourceMappingURL=book.js.a0d177194b652af37def.hot-update.js.map