...
})(["display:inline-block;width:100%;height:15rem;border-bottom:solid 2px #495057;"]);
...
})(["width:80%;margin:1.5rem;padding:1.5rem;float:right;border:solid 2px #495057;& > label{font-size:1rem;display:block;margin-top:0.5rem;}& > div{display:flex;& > label{font-size:1rem;display:block;margin-top:0.5rem;}label + label{margin-left:0.5rem;}}"]);
...
var Book = function Book() {
  ...
  })), __jsx(BookTopRightDiv, null, __jsx(BookTitle, null, book && book.name), __jsx("label", null, book && book.BookGenre[0].name), __jsx("label", null, "\uC791\uAC00 ", book && book.User.nickname), __jsx("div", null, __jsx("label", null, "\uC791\uD488\uB4F1\uB85D\uC77C", ' ', book && moment__WEBPACK_IMPORTED_MODULE_3___default()(book.createdAt).format('YY.MM.DD HH시 mm분')), __jsx("label", null, "\uCD5C\uADFC\uB4F1\uB85D\uC77C", ' ', book && (book.Episodes[book.Episodes.length - 1] ? moment__WEBPACK_IMPORTED_MODULE_3___default()(book.Episodes[book.Episodes.length - 1].createdAt).format('YY.MM.DD HH시 mm분') : moment__WEBPACK_IMPORTED_MODULE_3___default()(book.createdAt).format('YY.MM.DD HH시 mm분')))), __jsx("div", null, __jsx("label", null, "\uC5F0\uC7AC\uC218 ", book && book.Episodes.length, " \uD654"), __jsx("label", null, "\uC870\uD68C\uC218")), __jsx("div", null, __jsx("label", null, "\uCD94\uCC9C\uC218"), __jsx("label", null, "\uC120\uD638\uC791\uC218 ", book && book.likersCount)))), __jsx(BookSummaryDiv, null, book && book.summary));
};
...
//# sourceMappingURL=book.js.8d52b34a525b10c26590.hot-update.js.map