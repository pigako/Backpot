...
var BookTable = function BookTable(_ref) {
  ...
  var reverseEpisode = episode.splice().reverse(); // 번호 제목 날짜 조회 추천

  return __jsx(Table, null, __jsx("thead", null, __jsx("tr", null, __jsx("th", null, "\uBC88\uD638"), __jsx("th", null, "\uC81C\uBAA9"), __jsx("th", null, "\uB0A0\uC9DC"), __jsx("th", null, "\uC870\uD68C"), __jsx("th", null, "\uCD94\uCC9C"))), __jsx("tbody", null, episode.length ? isASC ? episode.map(function (v) {
    return __jsx("tr", {
      key: +v.id,
...
//# sourceMappingURL=book.js.31eddbce7437e921af57.hot-update.js.map