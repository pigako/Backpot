...
var Board = function Board() {
    ...
    if (window.scrollY + document.documentElement.clientHeight > document.documentElement.scrollHeight - 300) {
      if (hasMoreBoards) {
        ...
        if (!lastIdArray.includes(lastId)) {
          dispatch({
            type: _reducers_board__WEBPACK_IMPORTED_MODULE_8__["LOAD_BOARDS_REQUEST"],
            lastId: lastId,
            keyword: keyword
          });
  ...
  var onChangeKeyword = Object(react__WEBPACK_IMPORTED_MODULE_2__["useCallback"])(function (e) {
    setKeyword(e.target.value);
  }, []);
  var onSearchBoard = Object(react__WEBPACK_IMPORTED_MODULE_2__["useCallback"])(function (e) {
    e.preventDefault();
    dispatch({
      type: _reducers_board__WEBPACK_IMPORTED_MODULE_8__["CHANGE_BOARD_KEYWORD"],
      data: keyword
    });
    dispatch({
      type: _reducers_board__WEBPACK_IMPORTED_MODULE_8__["LOAD_BOARDS_REQUEST"],
  ...
  }), __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
//# sourceMappingURL=board.js.51dfe84584fcede56c43.hot-update.js.map