...
})(["border-collapse:separate;border-spacing:1px;background:white;border-radius:12px;overflow:hidden;margin:1rem auto;width:98%;& th{padding:1rem;background:#148cff;color:white;}& td{padding:1rem;border-bottom:1px solid #7053c4;cursor:pointer;}& th:nth-child(1),th:nth-child(4),th:nth-child(5){width:10%;text-align:center;}& th:nth-child(3){width:12%;text-align:center;}& tr:hover{background:#495057;color:white;}"]);
...
//# sourceMappingURL=book.js.16b0fd9d708dde7ed44c.hot-update.js.map