...
var LikedBook = function LikedBook(_ref) {
  ...
  }, __jsx("a", null, __jsx(Bookname, null, moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(moment__WEBPACK_IMPORTED_MODULE_4___default()(book.recentDay, 'YYYY-MM-DD HH:mm').diff(moment__WEBPACK_IMPORTED_MODULE_4___default()().format('YYYY-MM-DD HH:mm'))).asHours() > -24 ? "New" : null, book.name))));
};
...
//# sourceMappingURL=_app.js.39f119b382ce0153a9d3.hot-update.js.map