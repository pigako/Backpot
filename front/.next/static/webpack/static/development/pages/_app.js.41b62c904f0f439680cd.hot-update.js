...
})(["width:50px;height:50px;text-align:center;float:", ";& > a{color:white;height:50px;display:flex;align-items:center;justify-content:center;}"], function (props) {
  return props.flow ? right : left;
});
...
var Header = function Header() {
  return __jsx(Menu, null, __jsx(List, null, __jsx(Item, {
    ...
    href: "/search"
  }, __jsx("a", null, "Search"))), __jsx(Item, {
    flow: 'right'
  }, __jsx(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
    href: "/login"
  }, __jsx("a", null, "LogIn")))));
...
//# sourceMappingURL=_app.js.41b62c904f0f439680cd.hot-update.js.map