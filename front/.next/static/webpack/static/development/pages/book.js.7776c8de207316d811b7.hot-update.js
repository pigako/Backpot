...
var Book = function Book() {
  ...
  })), __jsx(BookTopRightDiv, null, __jsx(BookTitle, null, book && book.name), __jsx("label", null, book && book.BookGenre[0].name), __jsx("label", null, "\uC791\uAC00 ", book && book.User.nickname), __jsx("label", null, "\uC791\uD488\uB4F1\uB85D\uC77C ", book && book.createdAt), __jsx("label", null, "\uCD5C\uADFC\uB4F1\uB85D\uC77C", ' ', book && (book.Episodes[book.Episodes.length - 1] ? book.Episodes[book.Episodes.length - 1].createdAt : book.createdAt)), __jsx("label", null, "\uC5F0\uC7AC\uC218 ", book && book.Episodes.length, " \uD654"), __jsx("label", null, "\uC870\uD68C\uC218"), __jsx("label", null, "\uCD94\uCC9C\uC218"), __jsx("label", null, "\uC120\uD638\uC791\uC218"))), __jsx(BookSummaryDiv, null, book && book.summary));
};
...
//# sourceMappingURL=book.js.7776c8de207316d811b7.hot-update.js.map