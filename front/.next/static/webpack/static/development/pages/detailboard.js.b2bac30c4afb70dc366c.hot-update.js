...
})(["height:2rem;background:#e7e7e7;display:flex;align-items:center;& > label{font-size:1rem;font-weight:bold;margin-left:1rem;}"]);
...
var DetailBoard = function DetailBoard(_ref) {
  ...
  return __jsx(SBoard, null, __jsx(SDetailBoardTitle, null, "\uCD94\uCC9C\uAC8C\uC2DC\uAE00"), __jsx(SBoardTop, null, __jsx(SBoardTitle, null, __jsx(SBoardTitleLabel, null, board.title), __jsx(SBoardWriterLabel, null, __jsx("strong", null, board.User.nickname), " \uB2D8"), __jsx(SBoardCreateLabel, null, moment__WEBPACK_IMPORTED_MODULE_5___default()(board.createdAt).format('YY.MM.DD HH시 mm분'))), __jsx(SBoardTitleButtonDiv, null, __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  })), __jsx(SBoardComment, null, __jsx(SBoardCommentCountDiv, null, __jsx("label", null, "\uB313\uAE00 0\uAC1C"))));
};
...
//# sourceMappingURL=detailboard.js.b2bac30c4afb70dc366c.hot-update.js.map