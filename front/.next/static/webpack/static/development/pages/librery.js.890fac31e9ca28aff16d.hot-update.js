...
var Librery = function Librery() {
  ...
  var _useSelector = Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["useSelector"])(function (state) {
    return state.user.otherUserInfo;
      ...
      user = _useSelector.otherUserInfo; // if (useSelector(state => state.user.otherUserInfo)) {
  //   const { otherUserInfo: user } = useSelector(
  //     state => state.user.otherUserInfo,
  //   );
  // } else {
  //   const { me: user } = useSelector(state => state.user.me);
  // }


  console.log('Librery', user);
  ...
  }), __jsx(NovelButtonDiv, null, user.Books[0] ? null : __jsx("p", null, "\uC5F0\uC7AC\uC911\uC778 \uC18C\uC124\uC774 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4."), __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"], null, "\uC0C8 \uC791\uD488"))), __jsx(MyBoard, null, __jsx("p", null, "\uC791\uC131\uD55C \uAC8C\uC2DC\uAE00 \uBAA9\uB85D"), user.Boards.length ? __jsx(_components_BoardTable__WEBPACK_IMPORTED_MODULE_8__["default"], {
    board: user.Boards
  }) : null, __jsx(BoardButtonDiv, null, user.Boards.length ? null : __jsx("p", null, "\uC791\uC131\uD55C \uAC8C\uC2DC\uAE00\uC774 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4."), __jsx(_components_designs_Button__WEBPACK_IMPORTED_MODULE_7__["default"], null, "\uC0C8 \uAC8C\uC2DC\uAE00"))));
};
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          // console.log('Lib user', state.user);
          // if (id !== (state.user.me && state.user.me.userId)) {
...
//# sourceMappingURL=librery.js.890fac31e9ca28aff16d.hot-update.js.map