...
var BoardTable = function BoardTable(_ref) {
  ...
  return __jsx(Table, null, __jsx("thead", null, __jsx("tr", null, __jsx("th", null, "\uBC88\uD638 "), __jsx("th", null, "\uC81C\uBAA9"), __jsx("th", null, "\uC791\uC131\uC77C\uC2DC"))), __jsx("tbody", null, board.map(function (v) {
    return __jsx("tr", {
      key: +v.id
    }, __jsx("td", null, v.id), __jsx("td", null, v.title), __jsx("td", null, moment__WEBPACK_IMPORTED_MODULE_3___default()(v.createdAt).format('YYYY.MM.DD')));
  })));
};
...
//# sourceMappingURL=librery.js.dc1706d267cc8d7967a7.hot-update.js.map