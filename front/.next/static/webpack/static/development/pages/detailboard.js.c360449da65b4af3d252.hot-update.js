    ...
    switch (action.type) {
      ...
      case LOAD_BOARDS_REQUEST:
        ...
        if (draft.hasMoreBoards) {
          console.log("\n          ------------------------\n          ------------------------\n          ".concat(draft.hasMoreBoards, "\n          ").concat(action.lastId, "\n          ------------------------\n          ------------------------\n          "));

          if (!action.lastId) {
            console.log('===============');
          }

          action.lastId ? draft.hasMoreBoards : false;
        } // draft.hasMoreBoards = ;
...
//# sourceMappingURL=detailboard.js.c360449da65b4af3d252.hot-update.js.map