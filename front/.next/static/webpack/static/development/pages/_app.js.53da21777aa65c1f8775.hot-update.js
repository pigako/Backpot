...
var LikedBook = function LikedBook(_ref) {
  ...
  }, __jsx("a", null, __jsx(Bookname, null, book.name, moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(moment__WEBPACK_IMPORTED_MODULE_4___default()(book.recentDay, 'YYYY-MM-DD HH:mm').diff(moment__WEBPACK_IMPORTED_MODULE_4___default()().format('YYYY-MM-DD HH:mm'))).asHours() > -24 ? __jsx("p", null, "New") : null))));
};
...
//# sourceMappingURL=_app.js.53da21777aa65c1f8775.hot-update.js.map