...
})(["border-collapse:separate;border-spacing:1px;background:white;border-radius:6px;overflow:hidden;margin:0 auto;width:98%;& th{background:#ffed86;}& td{border-bottom:1px solid #7053c4;}& th:nth-child(1){width:10%;text-align:center;}& td:nth-child(1){text-align:center;}& th:nth-child(3),th:nth-child(4){width:12%;}& td:nth-child(3),td:nth-child(4){text-align:center;}"]);
...
//# sourceMappingURL=librery.js.c3259ed99835ef396b8b.hot-update.js.map